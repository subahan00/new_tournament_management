                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-yellow-600 focus:ring-yellow-500 border-gray-600 rounded bg-gray-800/70 cursor-pointer"
                    />
                    <label htmlFor="remember-me" className="ml-2 block text-sm text-yellow-100/70 tracking-wide cursor-pointer">
                      Remember me
                    </label>
                  </div>
